...
public class CRUDGUILimangatus extends javax.swing.JFrame {
    ...
    private void jButtonHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonHapusActionPerformed
        // TODO add your handling code here:
        em.getTransaction().begin();
        Buku hapusBuku = em.find(Buku.class, jTextFieldISBN.getText());
        em.remove(hapusBuku);
        em.getTransaction().commit();
        tampilanTabel();
        kosongkanTextField();
...
//            if (sql.next()) {
//                String kodeProdi = sql.getString("isbn");
//                jTextFieldISBN.setText(kodeProdi);
//                String namaProdi = sql.getString("judul_buku");
//                jTextFieldJudulBuku.setText(namaProdi);
//                String jenjang = sql.getString("tahun_terbit");
//                jTextFieldTahunTerbit.setText(jenjang);
//                String namaKaprodi = sql.getString("penerbit");
//                jTextFieldNamaPenerbit.setText(namaKaprodi);
//            }
//        } catch (Exception e) {
//        }
        int row = jTable2.getSelectedRow();
    ...
    private void jButtonUploadCSVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUploadCSVActionPerformed
        ...
        try {
            ...
            if (i == JFileChooser.APPROVE_OPTION) {
                ...
                // Membuat daftar entitas untuk penyimpanan batch
                List<Buku> entitasBatch = new ArrayList<>();
                ...
                for (CSVRecord csvRecord : csvParser) {
                    ...
                    entitasBatch.add(csvSimpanBuku);
//                    for (long beh = 0; beh <= csvRecord.getRecordNumber(); beh++) {
//                    }
                }

                // Membuka satu transaksi untuk seluruh operasi penyimpanan batch
                em.getTransaction().begin();

                // Menyimpan entitas dalam batch
                for (int b = 0; b < entitasBatch.size(); b++) {
                    Buku buku = entitasBatch.get(b);
                    em.persist(buku);
                    // flush and clear memory
                    if (i % entitasBatch.size() == 0) {
                        em.flush();
                        em.clear();
                    }
                }
